...
const NavMenu = () => {
  ...
  const fetchTabs = useCallback(async () => {
    ...
    const response = await fetch(`${utils.getServerUrl().REACT_APP_API_URL}/getTabs/${userData.uid}`, requestOptions);
  ...
  const removeTab = (e) => {
    ...
    fetch(`${utils.getServerUrl().REACT_APP_API_URL}/removeTab`, requestOptions);
