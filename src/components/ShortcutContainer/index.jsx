...
const ShortcutContainer = () => {
  ...
  const fetchShortcuts = useCallback(async () => {
    ...
    const response = await fetch(`${secrets.REACT_APP_API_URL}/getShortcuts/${userData.uid}/${tab.id}`, requestOptions);
  ...
  const removeShortcut = async (e) => {
    ...
    const remove = await fetch(`${secrets.REACT_APP_API_URL}/removeShortcut`, requestOptions);
